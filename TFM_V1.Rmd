...
#### Se genera un "Lineal model" para cada Who_Region
**** Todos los "lm" superan de R2 un 0.9, excepto América que tiene un R2 muy bajo "0.01", porque sus valores tienen poca variabilidad.
...
#### Se actualizanal dataset las estimaciones de estos indicadores
```{r}
