...
library(WDI)
#######################
library(RMariaDB)   #ERRROOOOOORRRR
library(tidyr)   #ERRROOOOOORRRR
library(data.table)   ####ERRORRRRRRRRRR
library(pastecs)
library(VIM)
library(Amelia)
library(pryr)
...
predic_model_pcr<-model_pcr %>% predict(test_data)

data_frame(RMSE=caret::RMSE(predic_model_pcr,test_data$Rate_Mort_Child),
           MAE= caret::MAE(predic_model_pcr,test_data$Rate_Mort_Child),
           RSquare=caret::R2(predic_model_pcr,test_data$Rate_Mort_Child))


plot(varImp(model_pcr),15,main="PCR")
